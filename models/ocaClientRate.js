...
module.exports = () => {
  ...
  OcaClientRate.init({
    ...
    timestamps: true,
    underscored: true,
    // Sin paranoid: valor "actual" por client_id, igual criterio que ClientItemRate — el
    // histórico vive en OcaClientRateHistory. Deliberadamente separado de ClientItemRate: es un
